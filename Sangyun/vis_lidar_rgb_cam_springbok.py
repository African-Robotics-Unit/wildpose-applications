...
def visualize_open3d(pcd_with_rgb, obj_pos_colors, obj_dict, cam_plotter=None):
    ...
    pcd_with_rgb = pcd_with_rgb[pcd_with_rgb[:,2] > 105]
...
file_path_lidar = 'springbok/public-archivedwl-36/lidar/'
file_path_rgb = 'springbok/public-archivedwl-36/sync_rgb/'
file_path_mask = 'springbok/public-archivedwl-36/masks2/'
...
#img_dict = get_2D_gt('labeling/coco/train.json')
img_dict = get_2D_gt('labeling2/train.json')
